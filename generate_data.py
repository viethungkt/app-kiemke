...
def generate():
    ...
    scratch_dir = r"C:\Users\HUE LINH\.gemini\antigravity-ide\scratch"
    
    with open(os.path.join(scratch_dir, "data_kho.js"), "w", encoding="utf-8") as f:
    ...
    with open(os.path.join(scratch_dir, "data_vattu.js"), "w", encoding="utf-8") as f:
    ...
    print("Successfully generated data files in scratch directory.")
